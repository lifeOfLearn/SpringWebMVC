...
public class AnnotationControllerDemo2Test {
	
	@Autowired
	private AnnotationControllerDemo2 annControllerDemo;
	
	@Autowired
	private ApplicationContext context;
	
	private String beanName = "controller2";
	
	private Class<?> clazzName = AnnotationControllerDemo2.class;
